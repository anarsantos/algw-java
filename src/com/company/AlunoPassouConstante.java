...
/*O seu programa deve receber a nota do aluno e depois você vai fazer uma operação lógica
para saber se a nota do aluno é maior que 7.0. O resultado dessa operação lógica deve ser atribuído
a uma variável do tipo Boolean constante.
...
public class AlunoPassouConstante {
    public static void main(String[] args) {
        Scanner teclado = new Scanner(System.in);

        final Double notaParaSerAprovado = 7.0;

        System.out.print("Qual é a nota do aluno: ");
        Double notaAluno = teclado.nextDouble();

        Boolean passouDeAno = notaAluno >= notaParaSerAprovado;
